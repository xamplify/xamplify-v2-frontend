export let textTS = `<p class="user-select-all">This paragraph will be entirely selected when clicked by the user.</p>
                        <p class="user-select-auto">This paragraph has default select behavior.</p>
                        <p class="user-select-none mb-0">This paragraph will not be selectable when clicked by the user.</p>`;
export let pointerTS = ` <p><a href="javascript:void(0)" class="pe-none text-primary fw-medium text-decoration-underline" tabindex="-1">This link</a> can not be clicked.</p>
...
export let LinkTS= ` <p><a class="link-opacity-10" href="javascript:void(0)">Link opacity 10</a></p>
...
export let LinkHoverTS= `<a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover text-decoration-underline" href="javascript:void(0)">
                            Underline opacity 0
                        </a>`;
export let LinkUnderlineTS = `<p><a href="javascript:void(0)" class="link-underline-primary text-decoration-underline">Primary underline</a></p>
...
export let LinkUnderlineOffsetTS = `<p><a href="javascript:void(0)" class="text-decoration-underline">Default link</a></p>
...
export let LinkUnderlineOpacityTS = ` <p><a class="text-decoration-underline link-offset-2 link-underline link-underline-opacity-0" href="javascript:void(0)">Underline opacity 0</a></p>
                   ...
                   `;
export let LinkHoverOpacityTS = `  <p><a class="link-opacity-10-hover" href="javascript:void(0)">Link hover opacity 10</a></p>
...
export let ColoredLinkTS = `<p><a href="javascript:void(0)" class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover text-decoration-underline">Primary link</a></p>
