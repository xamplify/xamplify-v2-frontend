...
export let listgroupTS = ` <ul class="list-group">
...
export let listgroupTS1 = `      <ul class="list-group">
...
export let listgroupTS10 = ` <ol class="list-group list-group-numbered">
...
export let listgroupTS11 = `  <ol class="list-group list-group-numbered">
<li class="list-group-item">Simply dummy text of the printing.</li>
<li class="list-group-item">There are many variations of passages.</li>
<li class="list-group-item">All the Lorem Ipsum generators.</li>
<li class="list-group-item">Written in 45 BC. This book is a treatise on the theory.</li>
...
export let listgroupTS12 = ` <ul class="list-group">
<li class="list-group-item">
...
export let listgroupTS13 = `         <div class="list-group">
...
export let listgroupTS15 = `  <ul class="mb-3 list-group list-group-horizontal">
