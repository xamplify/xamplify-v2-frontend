...
export let StackedChartData = {
  ...
  colors: ['#546dfe', '#d77cf7', '#f4a742', '#ee335e'],
  responsive: [
    {
      breakpoint: 480,
      options: {
...
export let StackedBarChartData = {
  ...
  colors: ['#546dfe', '#d77cf7', '#f4a742', '#ee335e', '#49b6f5'],
  grid: {
    borderColor: '#f2f5f7',
  },
  title: {
...
export let PatternedBarChartData = {
  ...
  colors: ['#546dfe', '#d77cf7', '#f4a742', '#49b6f5'],
  title: {
...
export let MultipleAxixChartData = {
  series: [
    ...
    },
    {
      name: 'Cashflow',
      type: 'column',
      data: [11, 30, 31, 34, 41, 49, 55, 60],
    },
    {
      name: 'Revenue',
      type: 'line',
      data: [20, 45, 40, 55,60, 70, 70, 80],
    },
  ],
  chart: {
    height: 320,
